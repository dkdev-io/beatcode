...
import { Volume2, VolumeX, Trash2, BookmarkPlus, GripVertical, Plus, X } from 'lucide-react';
...
export const StemRow: React.FC<StemRowProps> = ({ stem }) => {
  ...
  return (
    <div
      ref={setNodeRef}
      style={style}
      className={`relative flex flex-col xl:flex-row items-stretch xl:items-center gap-4 p-4 rounded-xl border border-zinc-800/80 border-l-4 shadow-lg backdrop-blur-md transition-all ${
